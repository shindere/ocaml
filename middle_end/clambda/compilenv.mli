...
(* Compilation environments for compilation units for the clambda middle-end *)
...
val current_unit_linkage_name: unit -> 'a (* Linkage_name.t *)
        (* Return the linkage_name of the unit being compiled.
           flambda-only *)

val current_unit: unit -> 'a (* Compilation_unit.t *)
        (* flambda-only *)

val current_unit_symbol: unit -> 'a (* Symbol.t *)
        (* flambda-only *)
...
val approx_env: unit -> 'a (* unit -> Export_info.t *)
