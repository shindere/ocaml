...
(* Interface for the FLambda middle-endmodule *)
...
val default_ui_export_info: export_info

val get_clambda_approx : unit_infos -> export_infos

val approx_for_global: Compilation_unit.t -> export_info option
