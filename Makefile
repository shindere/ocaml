...
# Let the native libraries depend on the native compiler

$(ocamlcommon_CMX_FILES) $(ocamlbytecomp_CMX_FILES) \
$(ocamloptcomp_CMX_FILES) $(ocamltoplevel_CMX_FILES): ocamlopt$(EXE)
