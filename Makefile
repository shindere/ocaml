...
runtime/%.$(O): OC_CFLAGS = $(OC_BYTECODE_CFLAGS)
runtime/%.b.$(O): OC_CPPFLAGS = $(OC_BYTECODE_CPPFLAGS) $(runtime_CPPFLAGS)
$(DEPDIR)/runtime/%.$(D): \
...
runtime/%.n.$(O): OC_CPPFLAGS = $(OC_NATIVE_CPPFLAGS) $(runtime_CPPFLAGS)
$(DEPDIR)/runtime/%.n.$(D): \
